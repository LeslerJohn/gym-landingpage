    ...
    let productFeatures = [
        ...
        },
        {
            featureList: [
                "Eliminate guesswork",
                "Save time",
                "Achieve the performnce you seek",
                "Builds functional strength",
            ],
            description:
                "Enter as much information about yourself as you desire to ensure all workouts are personalized to your need.",
...
<SectionWrapper id="product">
    ...
    >
        <div class="flex flex-col gap-2">
            ...
            <h3
                class="text-4xl sm:text-5xl md:6xl max-w-[1000px] mx-auto w-full font-semibold text-center"
            >
            ...
            <ProductCard {productFeature} {index}
                ...
                {:else}
                    Workouts specific to your <span
                        class=" text-indigo-400 font-medium">evironment</span
                    >
                    and
